...
=======
  ...
  $(document).on("keydown", function (e) {
    ...
    if (activeSection.hasClass("sec3")) {
      activeSwiper = swiper;
    } else if (activeSection.hasClass("sec4")) {
      activeSwiper = swiper4;
    } else if (activeSection.hasClass("sec5")) {
      activeSwiper = swiper5;
    }
  ...
  $(".img-box").on("mouseenter", function () {
    ...
    $(this).on("scroll mousewheel", function (event) {
      event.stopPropagation();
>>>>>>> 965daa5c328a91fbe5c938c0b3790afb262d73e7
    });
  });
